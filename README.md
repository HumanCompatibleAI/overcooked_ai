...
For DRL implementations compatible with the environment and reproducible results to our paper, *[On the Utility of Learning about Humans for Human-AI Coordination](https://arxiv.org/abs/1910.05789)* (also see our [blog post](https://bair.berkeley.edu/blog/2019/10/21/coordination/)!), check out [this repo](https://github.com/HumanCompatibleAI/human_aware_rl).
