...
force_compute = True
DISPLAY = False
<<<<<<< HEAD:testing/agent_test.py
simple_mdp = OvercookedGridworld.from_layout_name('cramped_room', start_all_orders=[], cook_time=5)
large_mdp = OvercookedGridworld.from_layout_name('corridor', start_all_orders=[], cook_time=5)
=======
...
>>>>>>> housecleaning for agents and planners:overcooked_ai_py/agents/agent_test.py
...
<<<<<<< HEAD:testing/agent_test.py
    def test_two_coupled_agents(self):
        ...
        trajectory, _, reward, _ = env.run_agents(agent_pair, include_final_state=True, display=DISPLAY)
        print(reward)
...
#         agent_evaluator = AgentEvaluator({"layout_name": "cramped_room_o_1order"}, {"horizon": 100})
...
#         scenario_1_mdp = OvercookedGridworld.from_layout_name('small_corridor', cook_time=5)
...
#         scenario_1_mdp = OvercookedGridworld.from_layout_name('scenario1_s', cook_time=5)
#         mlp = MediumLevelPlanner.from_pickle_or_compute(scenario_1_mdp, NO_COUNTERS_PARAMS, force_compute=force_compute)
#         a0 = GreedyHumanModel(mlp)
#         a1 = CoupledPlanningAgent(mlp)
#         agent_pair = AgentPair(a0, a1)
...
#         #
#         eva = AgentEvaluator({"layout_name": "schelling_s", "cook_time": 5}, force_compute=force_compute)
...
#
#         eva = AgentEvaluator({"layout_name": "unident", "cook_time": 5}, force_compute=force_compute)
#         start_state = eva.env.mdp.get_standard_start_state()
...
#
#         eva = AgentEvaluator({"layout_name": "asymmetric_advantages", "cook_time": 5}, force_compute=force_compute)
#         start_state = eva.env.mdp.get_standard_start_state()
