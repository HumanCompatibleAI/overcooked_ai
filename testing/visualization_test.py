import unittest, os, pygame, copy, json, uuid
import numpy as np
from overcooked_ai_py.agents.benchmarking import AgentEvaluator
from overcooked_ai_py.agents.agent import RandomAgent
from overcooked_ai_py.mdp.overcooked_mdp import OvercookedGridworld, OvercookedState
from overcooked_ai_py.mdp.overcooked_mdp import Recipe
from overcooked_ai_py.utils import load_from_json, generate_temporary_file_path, NumpyArrayEncoder
...
class TestStateVisualizer(unittest.TestCase):
    ...
    def test_temporary_orders_display(self):
        for d in load_from_json(os.path.join(state_visualizer_dir, "render_state_data_test_temporary_orders_display.json")):
            test_render_state_from_dict(d)
...
class TestWebVisualizations(unittest.TestCase):
    def setUp(self):
        Recipe.configure({})
