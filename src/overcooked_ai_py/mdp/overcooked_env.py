...
class OvercookedEnv(object):
    ...
    def potential(self, mlam, state=None, gamma=0.99, potential_constants={}):
        """
        ...
        return self.mdp.potential_function(state, mp=mlam.motion_planner ,gamma=gamma, potential_constants=potential_constants)
