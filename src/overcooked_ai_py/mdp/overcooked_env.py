...
class OvercookedEnv(object):
    ...
    def potential(self, mlp, state=None, gamma=0.99, potential_constants={}):
        """
        ...
        return self.mdp.potential_function(state, mp=mlp.mp ,gamma=gamma, potential_constants=potential_constants)
