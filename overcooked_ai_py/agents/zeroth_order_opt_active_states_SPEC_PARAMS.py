...
if __name__ == "__main__":
    ...
    if starting_params == None:
        PERSON_PARAMS_HM = {'PERSEVERANCE_HM': 0.9284436422017908, 'TEAMWORK_HM': 0.9066967042694103,
         'RETAIN_GOALS_HM': 0.2374250486282764, 'WRONG_DECISIONS_HM': 0.14755746914540488, 'THINKING_PROB_HM': 1,
         'PATH_TEAMWORK_HM': 0.8652082374786169, 'RATIONALITY_COEFF_HM': 14.770001286731548, 'PROB_PAUSING_HM': 1}
    ...
    PERSON_PARAMS_FIXED = {"PROB_PAUSING_HM", "THINKING_PROB_HM"}
