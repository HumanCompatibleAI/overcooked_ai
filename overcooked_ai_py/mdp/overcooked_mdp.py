...
class OvercookedGridworld(object):
    ...
    def find_free_counters_valid_for_both_players(self, state, mlp):
        ...
        for free_counter in free_counters:
            ...
            if (True in [mlp.mp.is_valid_motion_start_goal_pair(one_player.pos_and_or, goal) for goal in goals]) and \
            (True in [mlp.mp.is_valid_motion_start_goal_pair(other_player.pos_and_or, goal) for goal in goals]):
